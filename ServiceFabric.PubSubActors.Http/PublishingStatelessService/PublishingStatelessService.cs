...
namespace PublishingStatelessService
{
    ...
    internal sealed class PublishingStatelessService : StatelessService, IPublishingStatelessService
    {
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            ...
            }, "StatelessFabricTransportServiceRemotingListener");
        }
        ...
        protected override async Task RunAsync(CancellationToken cancelServiceInstance)
        {
            ...
            while (!cancelServiceInstance.IsCancellationRequested)
            {
                ...
                ServiceEventSource.Current.ServiceMessage(_serviceContext, "Working-{0}", iterations++);
        ...
        {
            ServiceEventSource.Current.ServiceMessage(_serviceContext, "Publishing Message");
